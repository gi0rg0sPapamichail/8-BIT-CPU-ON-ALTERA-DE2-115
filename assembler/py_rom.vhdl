...
architecture Behavioral of py_rom is
   ...
   constant A_REG 	: STD_LOGIC_VECTOR(7 downto 0) := "00001010";
	...
	signal ROM : rom_type := (
        ...
        63 => PRT_OP & x"00" & x"00" & x"00",
        64 => INC2_OP & A_REG & A_REG & x"00",
        65 => CMPRROM_OP & A_REG & x"01" & x"00",
        66 => JEB_OP & x"00" & x"3B" & x"00",
        67 => MOV_OP & C_REG & x"4D" & x"00",
        68 => PRT_OP & x"00" & x"00" & x"00",
        69 => MOV_OP & C_REG & x"49" & x"00",
        70 => PRT_OP & x"00" & x"00" & x"00",
        71 => MOV_OP & C_REG & x"43" & x"00",
        72 => PRT_OP & x"00" & x"00" & x"00",
        73 => MOV_OP & C_REG & x"48" & x"00",
        74 => PRT_OP & x"00" & x"00" & x"00",
        75 => MOV_OP & C_REG & x"41" & x"00",
        76 => PRT_OP & x"00" & x"00" & x"00",
        77 => MOV_OP & C_REG & x"49" & x"00",
        78 => PRT_OP & x"00" & x"00" & x"00",
        79 => IN_OP & C_REG & x"00" & x"00",
        80 => MVR_OP & C_REG & C_REG & x"00",
        81 => PRT_OP & x"00" & x"00" & x"00",
        82 => HLT_OP & x"00" & x"00" & x"00",
        others => (others => '0')
    );
